...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 19 03:38:03 2022
...
def attention_network(n_class,IMG_HEIGHT, IMG_WIDTH,IMG_CHANNELS, n_filters=16, batchnorm=True):
    ...
    outputs = Conv2D(n_class, filters=1, kernel_size=1, strides=1,
...
def DeeplabV3Plus_resnet50(n_class, IMG_HEIGHT, IMG_WIDTH,IMG_CHANNELS):
    """
...
def DeeplabV3Plus_vgg16(n_class,IMG_HEIGHT, IMG_WIDTH,IMG_CHANNELS):
    """
     # Estimation_of_Road_Boundary_for_Intelligent_Vehicles_Based_on_DeepLabV3_Architecture.pdf or
     # https://www.researchgate.net/publication/354108791_Estimation_of_Road_Boundary_for_Intelligent_Vehicles_Based_on_DeepLabV3_Architecture
    """
...
def dense_unet_2d(n_class, IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS,kernel_initializer =  'he_uniform'):
    #Build the model for 128x128 and 2d images
    ...
    outputs = Conv2D(n_class, (1, 1), activation='sigmoid')(outputs) 
...
def ternausNet16(n_class,IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS, output_channels=1):
    ...
    if input_size[-1] < 3:
        ...
        input_shape = (input_size[0], input_size[1], 3)  # update input size
    else:
        x = inputs
    ...
    c9 = Conv2D(16, (3, 3), activation='relu', kernel_initializer='he_uniform', padding='same')(d1)
   ...
   # op = Activation('sigmoid')(op)  # note: ternaus excludes
    op = Conv2D(n_class,IMG_CHANNELS, (1, 1), activation='softmax')(d1) # 'sigmoid'
...
def unet_2d_model_128_128(n_class,IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS,kernel_initializer =  'he_uniform'):
    #Build the model for 128x128 and 2d images
    from keras.backend import tf as ktf
    ...
    outputs = Conv2D(n_class,IMG_CHANNELS, (1, 1), activation='softmax')(c9) # 'sigmoid'
...
def unet_2d_model_256_256(n_class,IMG_HEIGHT,IMG_WIDTH,IMG_CHANNELS,kernel_initializer =  'he_uniform'):
    ...
    outputs = Conv2D(n_class,1, (1, 1), activation='sigmoid')(c9)
